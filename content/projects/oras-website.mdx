...
I was chosen as a LFX Mnetorship 2023 intern for the ORAS project, mentored by [Feynman Zhou](https://twitter.com/FeynmanZhou).
...
![Initial Prototype](/articles/oras/old_home.webp)
...
-   **Enhanced Visibility and Reach**: The implementation of SEO strategies resulted in an impressive 80% boost, significantly elevating the project's search engine rankings. This surge in visibility led to its discovery by a broader audience, marking a significant achievement in expanding its reach.
